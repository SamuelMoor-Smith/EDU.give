...
import Background from "@/public/images/education_background.jpg"
...
export default function PageIllustration() {
  return (
    <>
      ...
      <div
        className="pointer-events-none absolute left-1/2 top-0 -z-10 w-full h-screen -translate-x-1/2 transform"
        aria-hidden="true"
      >
        <Image
