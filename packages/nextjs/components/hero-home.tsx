        ...
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="pb-12 text-center md:pb-16">
            ...
            <h1
              ...
              data-aos-delay={150}
            >
              EDU.give <br className="max-lg:hidden" />
              Giving at No Cost.
            </h1>
            <div className="mx-auto max-w-3xl">
              <p
                ...
                data-aos-delay={300}
              >
                A platform in which your staked returns are 
                donated to education-based charities in your name. 
                Your original stake is returned to you after lockup. 
              </p>
